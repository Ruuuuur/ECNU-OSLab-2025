...
void test_case_1()
{
    //page 变量被赋值但没使用，会报-Werror，这里注释掉
    // void *page = NULL; 
    while(1){
        pmem_alloc(true);
    }
...
![第二阶段测试用例一运行结果](pictures/test2-1.png)
